...
exports.getStockValue = async (req, res, next) => {
	try {
		...
		const result = await Reports.getStockValue(user_id);
...
exports.getRevenue = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getRevenue(start, end, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getReturns = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getReturns(start, end, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getTotalOrders = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getTotalOrders(start, end, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getDebts = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getDebts(start, end, user_id);
		res.status(200).send(result);
	} catch (error) {
		next(error);
	}
...
exports.getCustomerPayments = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getCustomerPayments(start, end, user_id);
		res.status(200).send(result);
	} catch (error) {
		next(error);
	}
...
exports.getCashBalance = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getCashBalance(start, end, user_id);
		res.status(200).send(result);
	} catch (error) {
		next(error);
	}
...
exports.getExpenses = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getExpenses(start, end, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getSupplierPayments = async (req, res, next) => {
	try {
		const { start, end } = req.params;
		const { user_id } = req.user;
		const result = await Reports.getSupplierPayments(start, end, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getTopSales = async (req, res, next) => {
	try {
		...
		const { user_id } = req.user;
		const result = await Reports.getTopSales(start, end, id, user_id);
		res.status(200).json(result);
	} catch (error) {
		next(error);
	}
...
exports.getTopCategories = async (req, res, next) => {
	...
	const { user_id } = req.user;
	try {
		let topCategories = await Reports.getTopCategories(start, end, user_id);
