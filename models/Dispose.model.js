...
class Dispose {
	// create dispose
	static async create(user_id, info, products) {
		...
		try {
			...
			const query = `INSERT INTO inventory_transactions (user_id_fk, product_id_fk, transaction_type, transaction_datetime, quantity, order_id_fk)
			VALUES ?;`;
