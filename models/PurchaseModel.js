...
class PurchaseOrders {
	...
	static async addOrder(order, items, payment, user) {
		...
		try {
			...
			let query = `INSERT INTO journal_vouchers (journal_date, user_id, journal_description, total_value) VALUES (?, ?, ?, ?)`;
			...
			if (payment) {
				...
				let query = `INSERT INTO journal_vouchers ( journal_number, user_id, journal_date, journal_description, total_value) VALUES (?, ?, ?, ?, ?)`;
	...
	static async editOrder(order, items, user_id) {
		...
		// 	)}`;
		// 	//insert to vouchers and journal_items
		// 	let query = `INSERT INTO journal_vouchers (journal_id, journal_number, journal_date, journal_description, total_value, user_id) VALUES (?, ?, ?, ?, ?, ?)`;
		// 	const [journal_voucher] = await connection.query(query, [
		// 		orderCheck.journal_voucher_id,
